import numpy as np
from ln2_series import HarmonicSeries
...
np.savetxt("errors_python.txt", np.column_stack((N_range, asc_err, des_err)), fmt='%d %.16f %.16f', header='N Ascending_Errors Descending_Errors')
